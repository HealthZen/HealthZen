...
class VideoFragmentM : Fragment() {

    private var _binding: FragmentVideoBinding? = null
    private val binding get() = _binding!!
    private var videoViewModel: VideoViewModelM? = null
    private val adapter: VideoAdapterM = VideoAdapterM()
    ...
    override fun onCreateView(
        ...
        videoViewModel =
            ViewModelProvider(this)[VideoViewModelM::class.java]
